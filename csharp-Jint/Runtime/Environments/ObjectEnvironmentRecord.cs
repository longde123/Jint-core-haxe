...
namespace Jint.Runtime.Environments
{
    ...
    public sealed class ObjectEnvironmentRecord : EnvironmentRecord
    {
        ...
        {
            _bindingObject.DefineOwnProperty(name, new PropertyDescriptor().Creator(Undefined.Instance, true, true, configurable), true);
        }
        ...
        public override JsValue ImplicitThisValue()
        {
            if (_provideThis)
            {
                return new JsValue().Creator(_bindingObject);
            }
