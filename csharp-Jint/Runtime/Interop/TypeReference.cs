...
namespace Jint.Runtime.Interop
{
    public class TypeReference : FunctionInstance, IConstructor, IObjectWrapper
    {
        ...
        public ObjectInstance Construct(JsValue[] arguments)
        {
            ...
            throw new JavaScriptException().Creator(Engine.TypeError, "No public methods with the specified arguments were found.");
        ...
        public override bool DefineOwnProperty(string propertyName, PropertyDescriptor desc, bool throwOnError)
        {
            if (throwOnError)
            {
                throw new JavaScriptException().Creator(Engine.TypeError, "Can't define a property of a TypeReference");
            }
        ...
        public override bool Delete(string propertyName, bool throwOnError)
        {
            if (throwOnError)
            {
                throw new JavaScriptException().Creator(Engine.TypeError, "Can't delete a property of a TypeReference");
            }
        ...
        public override void Put(string propertyName, JsValue value, bool throwOnError)
        {
            ...
            if (ownDesc == null)
            {
                if (throwOnError)
                {
                    throw new JavaScriptException().Creator(Engine.TypeError, "Unknown member: " + propertyName);
                }
                else
                {
                    return;
        ...
        public override PropertyDescriptor GetOwnProperty(string propertyName)
        {
            ...
            if (Type.IsEnum)
            {
                ...
                {
                    if ((string)enumNames.GetValue(i) == propertyName)
                    {
                        return new PropertyDescriptor().Creator((int)enumValues.GetValue(i), false, false, false);
                    }
                }
            ...
            return new PropertyDescriptor().Creator(new MethodInfoFunctionInstance(Engine, methodInfo), false, false, false);
        }
