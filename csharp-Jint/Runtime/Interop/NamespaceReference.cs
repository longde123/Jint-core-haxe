...
namespace Jint.Runtime.Interop
{
    ...
    public class NamespaceReference : ObjectInstance, ICallable
    {
        ...
        public override bool DefineOwnProperty(string propertyName, PropertyDescriptor desc, bool throwOnError)
        {
            if (throwOnError)
            {
                throw new JavaScriptException().Creator(Engine.TypeError, "Can't define a property of a NamespaceReference");
            }
        ...
        public override bool Delete(string propertyName, bool throwOnError)
        {
            if (throwOnError)
            {
                throw new JavaScriptException().Creator(Engine.TypeError, "Can't delete a property of a NamespaceReference");
            }
        ...
        public JsValue Call(JsValue thisObject, JsValue[] arguments)
        {
            ...
            for (int i = 0; i < arguments.Length; i++)
            {
                ...
                if (genericTypeReference.Equals( Undefined.Instance) || !genericTypeReference.IsObject() || genericTypeReference.AsObject().Class != "TypeReference")
                {
