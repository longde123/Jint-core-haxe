...
namespace Jint.Runtime
{
    ...
    public class TypeConverter
    {
        ...
        {
            if (input.Equals(Null.Instance) || input.Equals(Undefined.Instance))
            {
                return input;
            }
        ...
        public static bool ToBoolean(JsValue o)
        {
            ...
            if (o.Equals( Undefined.Instance) || o.Equals( Null.Instance))
            {
                return false;
            }
        ...
        public static double ToNumber(JsValue o)
        {
            ...
            if (o.IsObject())
            {
                var p = (IPrimitiveInstance)o.AsObject();
                if (p != null)
                {
                    o = p.PrimitiveValue;
                }
            ...
            if (o.Equals( Undefined.Instance))
            {
                return double.NaN;
            }

            if (o.Equals( Null.Instance))
            {
                return 0;
            }
        ...
        {
            return !type.IsValueType;//todo || Nullable.GetUnderlyingType(type) != null;
        }



        public static string ToString(double x, string p, CultureInfo cultureInfo)
        {
            throw new NotImplementedException();
        }

        public static string ToString(int p1, string p2)
        {
            throw new NotImplementedException();
        }

        public static string ToString(double m, string p)
        {
            throw new NotImplementedException();
        }

        public static string ToString(int p, CultureInfo cultureInfo)
        {
            throw new NotImplementedException();
        }
    }
