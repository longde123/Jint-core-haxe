...
namespace Jint
{
    public class Options
    {
        ...
        private TimeZone _localTimeZone = TimeZone.CurrentTimeZone;
        //todo  private TimeZoneInfo _localTimeZone =  TimeZoneInfo.Local;
        ...
        public Options LocalTimeZone(TimeZone timeZoneInfo)
        {
        ...
        internal TimeSpan GetBaseUtcOffset()
        { 
            return _localTimeZone.GetUtcOffset(DateTime.Now);
            //todo   return _localTimeZone.BaseUtcOffset;
        }
