...
namespace Jint.Parser
{
    public class JavaScriptParser
    {
        ...
        private static readonly string[] Keywords = new string[]  {"if", "in", "do", "var", "for", "new", "try", "let",
        ...
        private static readonly string[] StrictModeReservedWords = new string[]  {
            "implements",
            "interface",
            "package",
            "private",
        ...
        private static readonly string[] FutureReservedWords = new string[] 
        {
            "class",
            "enum",
            "export",
        ...
        public JavaScriptParser Creator(bool strict)
        {
            _strict = strict;
            return this;
        }
        ...
        private Token ScanPunctuator()
        {
                            ...
                            case 61: // =
                                {
                                    ...
                                    var token = new Token();
                                    token.Type = Tokens.Punctuator;
                                    token.Value = _source.Slice(start, _index);
                                    token.LineNumber = _lineNumber;
                                    token.LineStart = _lineStart;
                                    token.Range = new[] { start, _index };
                                    return token;
            ...
            if (ch1 == ch2 && ("+-<>&|".IndexOf(ch1) >= 0))
            {
                ...
                token.Type = Tokens.Punctuator;
                token.Value = ch1.ToString() + ch2.ToString();
                token.LineNumber = _lineNumber;
                token.LineStart = _lineStart;
                token.Range = new[] { start, _index };
        ...
        private Token ScanHexLiteral(int start)
        {
            ...
            token.Value = Convert.ToInt64(number, 16);
            token.LineNumber = _lineNumber;
            token.LineStart = _lineStart;
            token.Range = new[] { start, _index };
        ...
        private Token ScanOctalLiteral(int start)
        {
            ...
            var token = new Token();
            token.Type = Tokens.NumericLiteral;
            token.Value = Convert.ToInt32(number, 8);
            token.Octal = true;
            token.LineNumber = _lineNumber;
            token.LineStart = _lineStart;
            token.Range = new[] { start, _index };
        ...
        private Token CollectRegex()
        {
            ...
            if (_extra.Tokens != null)
            {
                ...
                token_.Type = Tokens.RegularExpression;
                token_.Value = regex.Literal;
                token_.Range = new[] { pos, _index };
                token_.Location = loc;
        ...
        {
            var debuggerStatement = new DebuggerStatement();
        ...
        {
            var labelledStatement = new LabelledStatement();
        ...
        {
            var newExpression = new NewExpression();
        ...
        {
            var thisExpression = new ThisExpression();
        ...
        private void ThrowUnexpected(Token token)
        {
            ...
            {
                if (IsFutureReservedWord((string)token.Value))
                {
                    ThrowError(token, Messages.UnexpectedReserved);
                }
                else if (_strict && IsStrictModeReservedWord((string)token.Value))
                {
        ...
        private ParsedParameters ParseParams(Token firstRestricted)
        {
            ...
            var parsedParameters = new ParsedParameters();
        ...
        private Statement ParseFunctionDeclaration()
        {
            ...
            IList<Identifier> parameters = tmp.Parameters;
        ...
        private class LocationMarker
        {
            ...
            {
                _marker = new int[] { index, lineNumber, index - lineStart, 0, 0, 0 };
            }
            ...
            public void Apply(SyntaxNode node, Extra extra, Func<SyntaxNode, SyntaxNode> postProcess)
            {
                ...
                {
                    node.Range = new int[] { _marker[0], _marker[3] };
                }
