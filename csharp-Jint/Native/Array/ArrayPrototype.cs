...
namespace Jint.Native.Array
{
    ...
    public sealed class ArrayPrototype : ArrayInstance
    {
        ...
        private JsValue Filter(JsValue thisObj, JsValue[] arguments)
        {
            ...
            for (var k = 0; k < len; k++)
            {
                ...
                if (kpresent)
                {
                    ...
                    {
                        a.DefineOwnProperty(to.ToString(), new PropertyDescriptor().Creator(kvalue, true, true, true), false);
                        to++;
                    }
                }
            }
        ...
        private JsValue Map(JsValue thisObj, JsValue[] arguments)
        {
            ...
            for (var k = 0; k < len; k++)
            {
                ...
                if (kpresent)
                {
                    ...
                    a.DefineOwnProperty(pk, new PropertyDescriptor().Creator(mappedValue, true, true, true), false);
                }
            }
        ...
        private JsValue Splice(JsValue thisObj, JsValue[] arguments)
        {
            ...
            for (var k = 0; k < actualDeleteCount; k++)
            {
                ...
                if (fromPresent)
                {
                    ...
                    a.DefineOwnProperty(k.ToString(), new PropertyDescriptor().Creator(fromValue, true, true, true), false);
                }
            }
        ...
        private JsValue Sort(JsValue thisObj, JsValue[] arguments)
        {
            if (!thisObj.IsObject())
            {
                throw new JavaScriptException().Creator(Engine.TypeError, "Array.prorotype.sort can only be applied on objects");  
            }
            ...
            if (!compareArg.Equals( Undefined.Instance))
            {
                compareFn = compareArg.TryCast<ICallable>(x =>
                {
                    throw new JavaScriptException().Creator(Engine.TypeError, "The sort argument must be a function");
                });
            }

            Comparison<JsValue> comparer = (x, y) =>
                {
                    if (x.Equals(Undefined.Instance) && y.Equals(Undefined.Instance))
                    {
                        return 0;
                    }

                    if (x.Equals( Undefined.Instance))
                    {
                        return 1;
                    }

                    if (y.Equals(Undefined.Instance))
                    {
                        return -1;
                    }
        ...
        private JsValue Slice(JsValue thisObj, JsValue[] arguments)
        {
            ...
            uint final;
            if (end.Equals(Undefined.Instance))
            {
            ...
            for (; k < final; k++)
            {
                ...
                if (kPresent)
                {
                    ...
                    a.DefineOwnProperty(TypeConverter.ToString(n),
                                        new PropertyDescriptor().Creator(kValue, true, true, true), false);
                }
                n++;
            }
        ...
        private JsValue Reverse(JsValue thisObj, JsValue[] arguments)
        {
            ...
            var lenVal = o.Get("length");
            var len = TypeConverter.ToUint32(lenVal);
            var middle = (uint)System.Math.Floor((decimal)len / 2);           
            uint lower = 0;
            while (lower != middle)
            {
        ...
        private JsValue Join(JsValue thisObj, JsValue[] arguments)
        {
            ...
            var lenVal = o.Get("length");
            var len = TypeConverter.ToUint32(lenVal);
            if (separator.Equals( Undefined.Instance))
            {
                separator = ",";
            }
            ...
            string r = element0.Equals( Undefined.Instance) || element0.Equals( Null.Instance)
                                  ? ""
            ...
            for (var k = 1; k < len; k++)
            {
                ...
                string next = element.Equals(Undefined.Instance) || element.Equals( Null.Instance)
                                  ? ""
        ...
        private JsValue ToLocaleString(JsValue thisObj, JsValue[] arguments)
        {
            ...
            if (firstElement.Equals(Null.Instance) || firstElement.Equals(Undefined.Instance))
            {
                r = "";
            }
            else
            ...
            for (var k = 1; k < len; k++)
            {
                ...
                if (nextElement.Equals( Undefined.Instance )|| nextElement.Equals(Null.Instance))
                {
                    r = "";
                }
                else
        ...
        private JsValue Concat(JsValue thisObj, JsValue[] arguments)
        {
            ...
            foreach (var e in items)
            {
                ...
                if (eArray != null)
                {
                    ...
                    for (var k = 0; k < len; k++)
                    {
                        ...
                        if (exists)
                        {
                            ...
                            a.DefineOwnProperty(TypeConverter.ToString(n), new PropertyDescriptor().Creator(subElement, true, true, true), false);
                        }
                        n++;
                    }
                }
                ...
                {
                    a.DefineOwnProperty(TypeConverter.ToString(n), new PropertyDescriptor().Creator(e, true, true, true), false);
                    n++;
                }
            }
            ...
            a.DefineOwnProperty("length", new PropertyDescriptor().Creator(n, null, null, null), false);
