...
namespace Jint.Native.Function
{
    ...
    public sealed class ScriptFunctionInstance : FunctionInstance, IConstructor
    {
            ...
            : base(engine, functionDeclaration.Parameters.Select(x => x.Name).ToArray(), scope, strict)
        {
            ...
            {
                DefineOwnProperty("name", new PropertyDescriptor().Creator(_functionDeclaration.Id.Name, null, null, null), false);
            }
        ...
        {
            var strictModeScope = (new StrictModeScope(Strict, true));
            ...
            else if (thisArg.Equals(Undefined.Instance) || thisArg.Equals(Null.Instance))
            {
            ...
            {
                JavaScriptException ex = new JavaScriptException().Creator(result.GetValueOrDefault());
