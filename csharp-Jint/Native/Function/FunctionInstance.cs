...
namespace Jint.Native.Function
{
    public abstract class FunctionInstance : ObjectInstance, ICallable
    {
        ...
        public virtual bool HasInstance(JsValue v)
        {
            ...
            if (!po.IsObject())
            {
                throw new JavaScriptException().Creator(_engine.TypeError, string.Format("Function has non-object prototype '{0}' in instanceof check", TypeConverter.ToString(po)));
            }
