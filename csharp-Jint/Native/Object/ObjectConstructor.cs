...
namespace Jint.Native.Object
{
    public sealed class ObjectConstructor : FunctionInstance, IConstructor
    {
        ...
        public override JsValue Call(JsValue thisObject, JsValue[] arguments)
        {
            ...
            if(arguments[0].Equals( Null.Instance) || arguments[0] .Equals( Undefined.Instance))
            {
                return Construct(arguments);
            }
        ...
        public JsValue GetOwnPropertyNames(JsValue thisObject, JsValue[] arguments)
        {
            ...
            if (s != null)
            {
                ...
                {
                    array.DefineOwnProperty(n.ToString(), new PropertyDescriptor().Creator(i.ToString(), true, true, true), false);
                    n++;
                }  
            }
            ...
            {
                array.DefineOwnProperty(n.ToString(), new PropertyDescriptor().Creator(p.Key, true, true, true), false);
                n++;
            }
        ...
        public JsValue Create(JsValue thisObject, JsValue[] arguments)
        {
            ...
            var o = oArg.TryCast<ObjectInstance>();
            if (o == null && !oArg.Equals(Null.Instance))
            {
                throw new JavaScriptException().Creator(Engine.TypeError);
            }
            ...
            if (!properties.Equals( Undefined.Instance))
            {
        ...
        public JsValue Keys(JsValue thisObject, JsValue[] arguments)
        {
            ...
            foreach (var prop in enumerableProperties)
            {
                ...
                array.DefineOwnProperty(
                    ...
                    new PropertyDescriptor().Creator(p, true, true, true), 
                    false);
                index++;
            }
            return array;
