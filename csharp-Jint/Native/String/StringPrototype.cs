...
namespace Jint.Native.String
{
    ...
    public sealed class StringPrototype : StringInstance
    {
        ...
        {
            var s = (StringInstance)TypeConverter.ToObject(Engine, thisObj);
            if (s == null)
            {
        ...
        private JsValue Substring(JsValue thisObj, JsValue[] arguments)
        {
            ...
            var intEnd = arguments.At(1).Equals(Undefined.Instance) ? len : (int)ToIntegerSupportInfinity(end);
        ...
        private JsValue Substr(JsValue thisObj, JsValue[] arguments)
        {
            ...
            var length = arguments.At(1).Equals(JsValue.Undefined) 
        ...
        private JsValue Split(JsValue thisObj, JsValue[] arguments)
        {
            ...
            if (separator.Equals( Null.Instance))
            {
                separator = Null.Text;
            }
            ...
            var rx = (RegExpInstance)TypeConverter.ToObject(Engine, separator);
                ...
                )
            {
                ...
                {
                    a.DefineOwnProperty("0", new PropertyDescriptor().Creator(s, true, true, true), false);
                    return a;
                }
                ...
                while (match.Success && index < limit)
                {
                    ...
                    a.DefineOwnProperty(index++.ToString(), new PropertyDescriptor().Creator(s.Substring(lastIndex, match.Index - lastIndex), true, true, true), false);
                    ...
                    for (int i = 1; i < match.Groups.Count; i++)
                    {
                        ...
                        a.DefineOwnProperty(index++.ToString(), new PropertyDescriptor().Creator(item, true, true, true), false);
                    ...
                    {
                        a.DefineOwnProperty(index++.ToString(), new PropertyDescriptor().Creator(s.Substring(lastIndex), true, true, true), false);                        
                    }
                }
            ...
            else
            {
                ...
                {
                    a.DefineOwnProperty(i.ToString(), new PropertyDescriptor().Creator(segments[i], true, true, true), false);
                }
        ...
        private JsValue Slice(JsValue thisObj, JsValue[] arguments)
        {
            ...
            var intEnd = arguments.At(1).Equals(Undefined.Instance) ? len : (int)TypeConverter.ToInteger(end);
        ...
        private JsValue Replace(JsValue thisObj, JsValue[] arguments)
        {
            ...
            {
                searchValue = new JsValue().Creator(Null.Text);
            }
            if (searchValue.IsUndefined())
            {
                searchValue = new JsValue().Creator(Undefined.Text);
            }

            var rx = (RegExpInstance)TypeConverter.ToObject(Engine, searchValue);
            if (rx != null)
            {
            ...
            else
            {
                ...
                while (lastMatch)
                {
                    ...
                    else
                    {
                        ...
                        a.DefineOwnProperty(TypeConverter.ToString(n), new PropertyDescriptor().Creator(matchStr, true, true, true), false);
                        n++;
                    }
                }
                if (n == 0)
        ...
        private JsValue LastIndexOf(JsValue thisObj, JsValue[] arguments)
        {
            ...
            if (arguments.Length > 1 && !arguments[1] .Equals(Undefined.Instance))
            {
