...
class FunctionPrototype extends jint.native.function.FunctionInstance
{
    public function new(engine:jint.Engine)
    {
        super(engine, null, null, false);
    }
    public static function CreatePrototypeObject(engine:jint.Engine):jint.native.function.FunctionPrototype
    {
        var obj:jint.native.function.FunctionPrototype = new jint.native.function.FunctionPrototype(engine);
        obj.Extensible = true;
    ...
    private function Bind(thisObj:jint.native.JsValue, arguments:Array<jint.native.JsValue>):jint.native.JsValue
    {
        ...
        var f:jint.native.function.BindFunctionInstance = new jint.native.function.BindFunctionInstance(Engine);
        ...
        var o:jint.native.function.FunctionInstance = (Std.is(target, jint.native.function.FunctionInstance) ? cast(target, jint.native.function.FunctionInstance) : null);
        if (o != null)
        {
    ...
    {
        var func:jint.native.function.FunctionInstance = thisObj.TryCast();
        if (func == null)
        {
