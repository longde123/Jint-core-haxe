...
class JsValue implements system.IEquatable<jint.native.JsValue>
{
    ...
    public function Creator_Double(value:Float):jint.native.JsValue
    {
        _object = null;
    ...
    public function Creator_String(value:String):jint.native.JsValue
    {
        _double = Math.NaN;
        _object = value;
    ...
    public function Creator_ObjectInstance(value:jint.native.object.ObjectInstance):jint.native.JsValue
    {
        _double = Math.NaN;
    ...
    private function Creator_Types(type:Int):jint.native.JsValue
    {
        _double = Math.NaN;
        _object = null;
        _type = type;
    ...
    public function TryCast<T: ()>(fail:(jint.native.JsValue -> Void) = null):T
    {
        if (IsObject())
        {
            var o:jint.native.object.ObjectInstance = AsObject();
            var t:T = (Std.is(o, T) ? cast(o, T) : null);
            if (t != null)
            {
                return t;
            }
    ...
    {
        return IsObject() && Std.is(AsObject(), T);
    }
    public function As<T: (jint.native.object.ObjectInstance)>():T
    {
        return (Std.is(_object, T) ? cast(_object, T) : null);
    }
    ...
    public function Equals(other:jint.native.JsValue):Bool
    {
    ...
    public static function FromObject(engine:jint.Engine, value:Dynamic):jint.native.JsValue
    {
        ...
        {
            var result:CsRef<jint.native.JsValue> = new CsRef<jint.native.JsValue>(null);
        ...
        if (instance != null)
        {
            return new jint.native.JsValue().Creator_ObjectInstance(instance);
        }
        if (Std.is(value, jint.native.JsValue))
        {
            return value;
        }
                        ...
                        if (arrayInstance != null)
                        {
                            ...
                            { //for
                                ...
                                while (k < len)
                                {
                                    ...
                                    if (kpresent)
                                    {
                                        var kvalue:jint.native.JsValue = arrayInstance.Get(pk);
    ...
    public function Invoke(arguments:Array<jint.native.JsValue>):jint.native.JsValue
    {
        return Invoke_JsValue_(Undefined, arguments);
    }
    public function Invoke_JsValue_(thisObj:jint.native.JsValue, arguments:Array<jint.native.JsValue>):jint.native.JsValue
    {
    ...
    override public function Equals_Object(obj:Dynamic):Bool
    {
        if (ReferenceEquals(null, obj))
        {
            return false;
        }
        return Std.is(obj, jint.native.JsValue) && Equals(obj);
    }
    ...
    {
        Undefined = new jint.native.JsValue().Creator_Types(jint.runtime.Types.Undefined);
        Null = new jint.native.JsValue().Creator_Types(jint.runtime.Types.Null);
